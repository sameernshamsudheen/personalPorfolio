...
import { experiences, skills } from "../data/index";
    ...
    <section className="max-container select-none">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          ...
          expertise to solve complex problems and drive innovation. Seeking a
          challenging, long-term career opportunity where I can contribute to
          the growth of the organization while delivering impactful results,
          enhancing user satisfaction, and fostering continuous professional
          development.
        </p>
      </div>
